...
<html lang="en">
    ...
    <body>
		...
		<div class="mb_heading">
			<h1>Casting@Online</h1>
		</div>
		<div id="mb_menu" class="mb_menu">
			<a href="#" data-speed="1000" data-easing="easeOutBack">Главная</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Мои Работы</a>
			<a href="#" data-speed="1000" data-easing="easeOutBack">Медиа</a>
			<a href="#" data-speed="1000" data-easing="easeInExpo">Контакты</a>
		</div>
