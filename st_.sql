...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 09 2013 г., 21:20
...
CREATE TABLE IF NOT EXISTS `anketa` (
  ...
  `famely` text NOT NULL,
  `name` text NOT NULL,
  `vorname` text NOT NULL,
  `birth_day` text NOT NULL,
  `birth_mon` text NOT NULL,
  `birth_jahr` int(4) NOT NULL,
  `sp` int(20) NOT NULL,
  `kids` int(255) NOT NULL,
  `pasport_yes` int(1) NOT NULL,
  `pasport_no` int(1) NOT NULL,
  `location` text NOT NULL,
  `metro` text NOT NULL,
  `colorHear` text NOT NULL,
  `colorEye` text NOT NULL
...
(1, 'gas23031@mail.ru', 'Reaper Germany', '7c222fb2927d828af22f592134e8932480637c0d', 'ru', '127.0.0.1', 66, '2013-08-09 08:30:35', '6d3d3817dc40b9107db08e9eeb1fccfb', '5372abf2ededbf43ed03a66a3502c1a3207678fd', 1, '1710e7d68a1d8b8abfb2b7fbb2715d4d515ebb97', 0, 1, '', ''),
(3, 'reapergermany@yandex.ru', 'Андрей', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', 'de', '127.0.0.1', 2, '2013-09-05 19:32:53', '2c5c84376e0c809f4f5b855d8d987904', '6e711ae1e4218d8af91db25fb9e75a8cee244826', 1, '', 0, 1, '', '');
