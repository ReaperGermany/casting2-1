<div class="offers-table">
        ...
        $field_list = array(
                ...
                //"code_atr"=>array('label'=>"Type", 'filter'=>'text'),
                "value"=>array('label'=>"Price", 'filter'=>'text'),
        ...
        <thead>
            <tr>
                <th colspan="<?php echo count($field_list)+1?>" align="right">
                    ...
                    <!--button onclick="filterOffersNac(this)">Filter</button>
                    <button onclick="resetFilterNac(this)">Reset Filter</button-->
					<button onclick="deleteNacenka_price(this)">Delete</button>
